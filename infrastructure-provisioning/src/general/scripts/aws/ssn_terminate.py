...
if __name__ == "__main__":
    ...
    ssn_conf['openldap_sg'] = ssn_conf['service_base_name'] + "*" + '-openldap'

    try:
        logging.info('[TERMINATE SSN]')
        print '[TERMINATE SSN]'
        params = "--tag_name {} --edge_sg {} --nb_sg {} --openldap_sg {} --service_base_name {}". \
                 format(ssn_conf['tag_name'], ssn_conf['edge_sg'], ssn_conf['nb_sg'], ssn_conf['openldap_sg'],
